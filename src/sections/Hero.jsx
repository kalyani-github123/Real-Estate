    ...
    return (
        <>
            <div className={`${darkMode ? 'dark bg-black' : 'light bg-white'}`}>
                ...
                <h1 data-aos="zoom-in" className='text-7xl text-white font-semibold lg:pr-[500px] pr-0 lg:leading-[70px] leading-[60px] '>Find your next dream Home with us</h1>
                <p data-aos="zoom-in" className='text-white text-3xl lg:pr-[500px] pr-0'>Luxury real estate that offers a diverse range of prestigious neighborhoods to suit every lifestyle.</p>
                </section>
            </div>
            ...
            <div className={`${darkMode ? 'dark bg-black' : 'light bg-transparent'} z-10`}>
                <div data-aos="zoom-in" id='form' className={`${darkMode ? 'dark bg-gray-800' : 'light bg-white' } lg:w-[70%] w-full m-auto grid lg:grid-cols-4 grid-cols-1 justify-center items-center gap-6 p-8 rounded-xl -mt-14  `}>
                    <div className='w-full'>
                        ...
                        <input type="text" placeholder='Enter an address, state, city or pincode' className='bg-white  p-2 w-full mt-2 border-b-[1px] border-[#c9c7c1] rounded-lg ' />
                    </div>

                    <div className='w-full '>
                    <h1 className='text-black font-semibold dark:text-white '>TYPE</h1>
                    <select name="selectOption" id="selectOption" className='bg-white p-2 border-b-[1px] w-full mt-2 border-[#c9c7c1] text-gray-500 text-md rounded-lg'>
                        <option value="" disabled selected>Select Property</option>
                        <option value="Option1">Luxury Rentals</option>
                        <option value="Option2">Luxury Sales</option>
