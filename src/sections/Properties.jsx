...
import { FaBath, FaShare, FaShareAlt, FaBed, FaUserCircle, FaPlus, FaHeart, FaMapMarkerAlt, FaVideo, FaCamera } from 'react-icons/fa'
    ...
    <div className={`${darkMode ? 'dark bg-black' : 'light bg-transparent'}`}>
      <section id="properties" className='lg:w-[90%] m-auto lg:px-20 px-6 py-20 w-full flex flex-col justify-center items-start gap-10'>
        <div className='flex flex-col justify-center items-start gap-4'>
          ...
          <h1 data-aos="zoom-in" className='text-black text-4xl font-semibold dark:text-white'>Explore Latest Properties</h1>
        </div>
            ...
            property.map((item,index)=>(
              <div data-aos="zoom-in" data-aos-delay="200" key={index} className='bg-white dark:bg-gray-800 rounded-xl w-full'>
                ...
                <div className='px-6 py-3 flex flex-col justify-center items-start gap-2 w-full'>
                  ...
                  <div id='owner-info' className='flex justify-between items-start mt-2 w-full' >
                    <div className='flex justify-center items-center gap-2'>
                      <FaUserCircle className='size-5 text-red-400'/>
                      <h1 className='dark:text-white'>{item.owner}</h1>
                    </div>
                    <div className='flex justify-center items-center gap-4'>
                      <div className='p-2 border-2 border-gray-200 hover:bg-black cursor-pointer transform hover:scale-110 transition-transform duration-300 rounded-md'>
